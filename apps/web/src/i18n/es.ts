export default {
  ...
  checklists: {
    ...
    subtitle: "Tu mercado del día, producto por producto.",
    empty: "Aún no tienes listas de compras. ¡Crea la primera!",
    newOne: "Nueva lista",
    name: "Nombre de la lista",
    namePlaceholder: "p. ej. Mercado de la semana",
    itemName: "producto",
    created: "Lista creada.",
    deleted: "Lista eliminada.",
    statusEnCurso: "En curso",
    statusCompletada: "Completada",
    progress: "{{percent}}% marcado · {{checked}} de {{total}}",
    totalEstimated: "Total estimado",
    totalPaid: "Total pagado",
    fromAccount: "Pagada con {{wallet}}",
    completedOn: "Completada el",
    addItem: "Añadir producto",
    addItemPlaceholder: "p. ej. Harina, Arroz, Pan…",
    priceTitle: "Registrar precio",
    priceHint:
      "Escribe el precio por unidad y la cantidad del producto. El subtotal se suma en {{currency}} y en {{other}}.",
    unitPrice: "Precio por unidad",
    quantity: "Cantidad",
    subtotal: "Subtotal",
    esUsd: "En USD",
    esVes: "En bolívares",
    completeTitle: "Completar lista",
    completeHint:
      "Cierra la lista eligiendo la cuenta del pago. El total se descuenta de inmediato del saldo.",
    completeAccount: "Cuenta del pago",
    completeAccountPlaceholder: "Elige una cuenta…",
    totalReal: "Total real (lo que marcó la caja)",
    totalRealHint: "Prefill del estimado: puedes corregirlo.",
    complete: "Completar y pagar",
    completing: "Procesando…",
    completed: "Lista completada y pago registrado.",
    receipt: "Detalle de la compra",
    receiptTotal: "Total",
    errorPrice: "El precio debe ser mayor que 0.01 (sin negativos).",
    errorQty: "La cantidad debe ser un entero de 1 en adelante.",
    errorAmount: "El total debe ser mayor que 0.01.",
    errorName: "Escribe un nombre de hasta 120 caracteres.",
  },
  profile: {
    title: "Perfil",
    name: "Nombre",
    ...
    navimemTitle: "Lo que Navi recuerda de ti",
    navimemDesc:
      "Navi aprende de tus registros para sugerirte cuentas y otros datos sin preguntar. Puedes borrar lo que quieras.",
    navimemEmpty:
      "Aún no hay preferencias aprendidas. Navi empezará a recordarlas cuando registres operaciones.",
    navimemPlaceholder: "Ej.: siempre pago luz en Banesco",
    navimemAdd: "Guardar",
