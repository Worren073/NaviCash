export default {
  ...
  checklists: {
    ...
    subtitle: "Your day's market, item by item.",
    empty: "You don't have any shopping lists yet. Create the first one!",
    newOne: "New list",
    name: "List name",
    namePlaceholder: "e.g. Weekly market",
    itemName: "item",
    created: "List created.",
    deleted: "List deleted.",
    statusEnCurso: "In progress",
    statusCompletada: "Completed",
    progress: "{{percent}}% checked · {{checked}} of {{total}}",
    totalEstimated: "Estimated total",
    totalPaid: "Total paid",
    fromAccount: "Paid with {{wallet}}",
    completedOn: "Completed on",
    addItem: "Add item",
    addItemPlaceholder: "e.g. Flour, Rice, Bread…",
    priceTitle: "Register price",
    priceHint:
      "Enter the unit price and the quantity. The subtotal is added in {{currency}} and in {{other}}.",
    unitPrice: "Unit price",
    quantity: "Quantity",
    subtotal: "Subtotal",
    esUsd: "In USD",
    esVes: "In bolivars",
    completeTitle: "Complete list",
    completeHint:
      "Finish the list by picking the payment account. The total is deducted from the balance right away.",
    completeAccount: "Payment account",
    completeAccountPlaceholder: "Pick an account…",
    totalReal: "Real total (what the register says)",
    totalRealHint: "Prefilled with the estimate: you can fix it.",
    complete: "Complete and pay",
    completing: "Processing…",
    completed: "List completed and payment registered.",
    receipt: "Purchase detail",
    receiptTotal: "Total",
    errorPrice: "The price must be greater than 0.01 (no negatives).",
    errorQty: "The quantity must be a whole number of 1 or more.",
    errorAmount: "The total must be greater than 0.01.",
    errorName: "Enter a name up to 120 characters.",
  },
  profile: {
    title: "Profile",
    name: "Name",
    ...
    naviConsentTitle: "How do you want Navi to remember?",
    naviConsentDesc1:
      "Navi can learn from your entries to suggest accounts and other details without asking.",
    naviConsentDesc2:
      "This information is stored exclusively in your account. The NaviCash team never has access to what Navi learns about you.",
    naviConsentDesc3:
      "It's completely optional. You can change this setting anytime from your profile.",
    naviConsentFull: "Full learning",
    naviConsentFullDesc: "Navi learns from your entries and remembers what you tell it.",
    naviConsentManual: "Manual only",
    naviConsentManualDesc:
      "Navi only remembers what you explicitly tell it with \"remember that…\".",
    naviConsentNone: "Don't remember anything",
    naviConsentNoneDesc: "Navi stores nothing about your preferences.",
    naviConsentConfirm: "Confirm",
    naviConsentCurrent: "Current Navi learning mode:",
