    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed bottom-24 left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-md -translate-x-1/2 flex-col overflow-hidden rounded-2xl border border-glass-border bg-white/60 shadow-[0_12px_40px_rgba(15,23,42,0.25)] backdrop-blur-2xl"
